...
export default function PostCommentsDrawer({
  ...
  return (
    <Modal 
      ...
      backdrop="opaque"
      hideCloseButton={true} /* Hides the default top-left 'X' */
      motionProps={{
        variants: {
    ...
    >
      <ModalContent>
        {(onClose) => (
          <>
            {/* Visual handle (clicking it closes the drawer as a fallback) */}
            ...
            <ModalHeader className="comm_sheetHeader">
              <div className="comm_sheetHeaderTitle">
                Comments <span className="comm_sheetCount">{comments.length}</span>
              </div>
